...
@pytest.fixture
def domain_rooms():
    room_1 = r.Room(code=uuid.uuid4(), size=215, price=39, longitude=-0.09998975, latitude=51.75436293,)
    room_2 = r.Room(code=uuid.uuid4(), size=405, price=66, longitude=0.18228006, latitude=51.74640997,)
    room_3 = r.Room(code=uuid.uuid4(), size=56, price=60, longitude=0.27891577, latitude=51.45994069,)
    room_4 = r.Room(code=uuid.uuid4(), size=93, price=48, longitude=0.33894476, latitude=51.39916678,)
...
# The first one checks that the value of the filters key in the dictionary used
# to create the request is actually used when calling the repository.
...
# These last two tests check the behaviour of the use case
# when the repository raises an exception or when the request is badly formatted.
